...
namespace theme_castle\privacy;
...
class provider implements
    ...
    const FONTTYPE = 'themecastlesettings_fonttype';
    /** The user preference for the enable accessibility toolbar. */
    const TOOLBAR = 'themecastlesettings_enableaccessibilitytoolbar';
    ...
    public static function get_metadata(collection $items) : collection {
        ...
        $items->add_user_preference(self::FONTTYPE, 'privacy:metadata:preference:themecastlesettings_fonttype');
        $items->add_user_preference(self::TOOLBAR, 'privacy:metadata:preference:themecastlesettings_enableaccessibilitytoolbar');
        return $items;
    }
    ...
    public static function export_user_preferences(int $userid) {
        ...
        if (isset($toolbar)) {
            writer::export_user_preference(
                ...
                self::TOOLBAR,
                $toolbar,
                get_string('privacy:themecastlesettings_enableaccessibilitytoolbar', 'theme_castle', $toolbar)
            );
            ...
            if (isset($fontsize)) {
                writer::export_user_preference(
                    ...
                    self::FONTSIZE,
                    $fontsize,
                    get_string('privacy:accessibilitystyles_fontsizeclass', 'theme_castle', $fontsize)
                );
            }
            ...
            if (isset($sitecolor)) {
                writer::export_user_preference(
                    ...
                    self::SITECOLOR,
                    $sitecolor,
                    get_string('privacy:accessibilitystyles_sitecolorclass', 'theme_castle', $sitecolor)
                );
            }
        }
        ...
        if (isset($fonttype)) {
            writer::export_user_preference(
                ...
                self::FONTTYPE,
                $fonttype,
                get_string('privacy:themecastlesettings_fonttype', 'theme_castle', $fonttype)
            );
        }
    }
}

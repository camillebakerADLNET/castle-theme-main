...
class accessibility extends external_api {
    ...
    public static function savethemesettings($formdata) {
        ...
        if ($data['fonttype'] && in_array($data['fonttype'], ['default', 'odafont'])) {
            ...
            set_user_preference('themecastlesettings_fonttype', $fonttype);
        }
        ...
        set_user_preference('themecastlesettings_enableaccessibilitytoolbar', $enableaccessibilitytoolbar);

        \core\notification::success(get_string('themesettingg:successfullysaved', 'theme_castle'));
    ...
    public static function getthemesettings() {
        return [
            'fonttype' => get_user_preferences('themecastlesettings_fonttype', 'default'),
            'enableaccessibilitytoolbar' => get_user_preferences('themecastlesettings_enableaccessibilitytoolbar', false)
        ];
    }

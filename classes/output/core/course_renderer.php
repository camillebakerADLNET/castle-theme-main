...
namespace theme_castle\output\core;

use html_writer;
use coursecat_helper;
use stdClass;
use core_course_list_element;
use theme_castle\util\course;

/**
 * Renderers to align castle's course elements to what is expect
 *
 * @package    theme_castle
 * @copyright  2022 ADL 
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class course_renderer extends \core_course_renderer {
    ...
    protected function coursecat_coursebox_content(coursecat_helper $chelper, $course) {
        ...
        return $this->render_from_template('theme_castle/castle_coursecard', $data);
    }

    ...
    function(jQuery, Notification, CustomEvents, Modal, ModalRegistry, Ajax) {
        ...
        var AccessibilityModal = function(root) {
            ...
            var request = Ajax.call([{
                methodname: 'theme_castle_getthemesettings',
                args: {}
            }]);
        ...
        AccessibilityModal.TYPE = 'theme_castle-themesettings_modal';
        ...
        AccessibilityModal.prototype.registerEventListeners = function() {
            ...
            this.getModal().on(CustomEvents.events.activate, SELECTORS.SAVE_BUTTON, function() {
                var request = Ajax.call([{
                    methodname: 'theme_castle_savethemesettings',
                    args: {
        ...
        if (!registered) {
            ModalRegistry.register(AccessibilityModal.TYPE, AccessibilityModal, 'theme_castle/accessibilitysettings_modal');
            registered = true;
        }

 ...
 * @return string
 */
function theme_castle_get_main_scss_content($theme) {
    global $CFG;
    ...
    } else if ($filename && ($presetfile = $fs->get_file($context->id, 'theme_castle', 'preset', 0, '/', $filename))) {
    ...
    // castle scss.
    $castlevariables = file_get_contents($CFG->dirroot . '/theme/castle/scss/castle/_variables.scss');
    $castle = file_get_contents($CFG->dirroot . '/theme/castle/scss/default.scss');

    // Combine them together.
    $allscss = $castlevariables . "\n" . $scss . "\n" . $castle;
 ...
 * @return string
 */
function theme_castle_get_extra_scss($theme) {
    $content = '';
 ...
 * @return string
 */
function theme_castle_get_pre_scss($theme) {
    $scss = '';
    $configurable = [
 ...
 */
function theme_castle_get_precompiled_css() {
    global $CFG;

    return file_get_contents($CFG->dirroot . '/theme/castle/style/moodle.css');
}
 ...
 * @return mixed
 */
function theme_castle_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    $theme = theme_config::load('castle');

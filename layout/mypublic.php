...
/**
 * A drawer based layout for the castle theme.
 *
...
$templatecontext = [
    ...
    'headerbuttons' => \theme_castle\util\extras::get_mypublic_headerbuttons($context, $user),
    'editprofileurl' => \theme_castle\util\extras::get_mypublic_editprofile_url($user, $courseid),
...
$themesettings = new \theme_castle\util\settings();

$templatecontext = array_merge($templatecontext, $themesettings->footer());

echo $OUTPUT->render_from_template('theme_castle/mypublic', $templatecontext);

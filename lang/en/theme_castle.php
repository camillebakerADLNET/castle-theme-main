...
$string['pluginname'] = 'Castle';
$string['configtitle'] = 'Castle';
$string['choosereadme'] = 'Castle is a modern highly-customisable theme. This theme is intended to be used directly, or as a parent theme when creating new themes utilising Bootstrap 4.';
...
$string['numbersfrontpagecontentdefault'] = '<h2>The Team at ADL are so excited for you to try this product!</h2>
...
$string['privacy:metadata:preference:themecastlesettings_fonttype'] = 'The user\'s preference for font type.';
$string['privacy:metadata:preference:themecastlesettings_enableaccessibilitytoolbar'] = 'The user\'s preference for enable the accessibility toolbar.';
...
$string['privacy:themecastlesettings_fonttype'] = 'The current preference for the font type is: {$a}.';
$string['privacy:themecastlesettings_enableaccessibilitytoolbar'] = 'The current preference for enable accessibility toolbar is to show it.';

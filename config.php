...
$THEME->scss = function($theme) {
    return theme_castle_get_main_scss_content($theme);
};
...
$THEME->extrascsscallback = 'theme_castle_get_extra_scss';
$THEME->prescsscallback = 'theme_castle_get_pre_scss';
$THEME->precompiledcsscallback = 'theme_castle_get_precompiled_css';
$THEME->yuicssmodules = [];
